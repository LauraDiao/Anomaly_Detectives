...
_Laura Diao, Jenna Yang, Benjamin Sam_
...
[A more in depth explanation and tutorial of DANE in the context of our project.](dane-details.md).
...
<img src="images/correlation_matrix.png" alt="correlation matrix" height="600"/>
...
<img src="images/max_tdelta.png" alt="a plot of max time delta, a temporal feature" width="600"/>
...
<img src="images/2-1Pkts.png" alt="a plot of 2 to 1 packets, a throughput feature" width="600"/>


# Methods

## Pipeline
<img src="images/pipeline2.png" alt="the data pipeline from start to end for our project" height="500"/>
...
## Anomaly Classifier
<img src="images/detection.png" alt="depicting how our anomaly detection system works" width="600"/>
...
<img src="images/latency_model_perf_with_latency_400-390_loss_10000-8000.png" alt="latency model performance" width="600"/>
...
<img src="images/loss_model_perf_with_latency_400_loss_10000-1000.png" alt="loss model performance" width="600"/>
<img src="images/latency_model_perf_with_latency_50-300_loss_100.png" alt="latency model performance" width="600"/>
